...
class Judger:
    ...
    def play(self, show=False, show_play=False):
        self.reset()
        ...
        while True:
            ...
            if show_play:
                print('\n Player {} chose ({}, {})'.format(symbol, i, j))
...
class Player:
    ...
    def feedReward(self, reward):
        ...
        for latestState in reversed(self.states):
            ...
            allStates[latestState][0].show()
            print('{} --> {} \n'.format(self.estimations[latestState], value))
    ...
    def takeAction(self):
        ...
        ### BAD NAMING: values are essentially postitions
        values = []
        for hash, pos in zip(nextStates, nextPositions):
            values.append((self.estimations[hash], pos))
            print('Position ({}, {}) : Value {}'.format(pos[0], pos[1], self.estimations[hash]))

        np.random.shuffle(values)  ### Why shuffle before sort, useless
        ### Use the largest value position
